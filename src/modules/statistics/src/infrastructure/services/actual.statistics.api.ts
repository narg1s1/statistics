...
export class ActualPeStatisticsApi {
  ...
  localBussinessId = this.envService.businessId;
  ...
  getDashboards() {
    return this.http.get(`${this.statisticsApiPath}/api/business/${this.localBussinessId}/dashboard`, {
      headers: {
  ...
  getDashboardsById(dashboardId: string) {
    return this.http.get(`${this.statisticsApiPath}/api/business/${this.localBussinessId}/dashboard/${dashboardId}`, {
      headers: {
        Authorization: `Bearer ${this.authTokenService.token}`,
      },
    });
  ...
  editDashboardName(dashboardId: string, payload) {
    return this.http.put(
      `${this.statisticsApiPath}/api/business/${this.localBussinessId}/dashboard/${dashboardId}`,
      payload,
      {
        headers: {
          Authorization: `Bearer ${this.authTokenService.token}`,
  ...
  createSingleDashboard(data: any) {
    return this.http.post(`${this.statisticsApiPath}/api/business/${this.localBussinessId}/dashboard`, data, {
      headers: {
        Authorization: `Bearer ${this.authTokenService.token}`,
      },
    });
  ...
  removeDashboard(dashboardId: string) {
    return this.http.delete(`${this.statisticsApiPath}/api/business/${this.localBussinessId}/dashboard/${dashboardId}`);
  }

  getWidgets(dashboardId: string) {
    return this.http.get(
      `${this.statisticsApiPath}/api/business/${this.localBussinessId}/dashboard/${dashboardId}/widget`,
      {
        headers: {
          Authorization: `Bearer ${this.authTokenService.token}`,
        },
  ...
  getWidgetsById(dashboardId: string, widgetId: string) {
    return this.http.get(
      `${this.statisticsApiPath}/api/business/${this.localBussinessId}/dashboard/${dashboardId}/widget/${widgetId}`,
      {
        headers: {
          Authorization: `Bearer ${this.authTokenService.token}`,
        },
  ...
  getWidgetTypes(dashboardId: string) {
    return this.http.get(
      `${this.statisticsApiPath}/api/business/${this.localBussinessId}/dashboard/${dashboardId}/widget/available-types`,
      {
        headers: {
          Authorization: `Bearer ${this.authTokenService.token}`,
        },
  ...
  getWidgetData(widgetType: string = 'transactions') {
    return this.http.get(`${this.statisticsApiPath}/api/business/${this.localBussinessId}/widgetData/${widgetType}`, {
      headers: {
        Authorization: `Bearer ${this.authTokenService.token}`,
      },
    });
  ...
  getWidgetTypeData() {
    return this.http.get(`${this.statisticsApiPath}/api/business/${this.localBussinessId}/widgetData/widget-types`, {
      headers: {
        Authorization: `Bearer ${this.authTokenService.token}`,
      },
    });
